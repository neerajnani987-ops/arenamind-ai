      ...
      () => {
        ...
        const dictionaries: Record<string, Record<string, string>> = {
          ...
          hindi: {
            ...
            parking: "हम पार्किंग जोन B (पूर्व) की सिफारिश करते हैं।\n- **कारण**: जोन A 86% क्षमता पर है और जोन C 98% क्षमता पर है, जिससे वाहनों के प्रवेश में देरी हो रही है।\n- **विश्वास**: 92%\n- **अनुशंसित कार्रवाई**: जोन B की तरफ जाएं जो 50% खाली है।\n- **अपेक्षित प्रभाव**: मुख्य प्रवेश द्वारों पर वाहनों की भीड़ को रोकता है।",
            food: "सबसे तेज़ विकल्प एरिना एक्सप्रेस कैफे (पूर्व) है जहां 4 मिनट का इंतजार है।\n- **कारण**: ग्रैंड फूड बाजार (पश्चिम) में ऑर्डर की संख्या अधिक है (18 मिनट का इंतजार)।\n- **विश्वास**: 88%\n- **अनुशंसित कार्रवाई**: त्वरित स्नैक्स के लिए पूर्व कॉन्कोर्स पर जाएं।\n- **अपेक्षित प्रभाव**: कतार में लगने वाले समय को 14 मिनट बचाता है।",
            washroom: "निकटतम शौचालय: शौचालय उत्तर (टियर 1)।\n- **कारण**: शौचालय पूर्व (टियर 2) निर्धारित सफाई के लिए बंद है।\n- **विश्वास**: 94%\n- **अनुशंसित कार्रवाई**: उत्तर कॉन्कोर्स शौचालय पर जाएं (2 मिनट का इंतजार)।\n- **अपेक्षित प्रभाव**: सफाई की कमी को दूर करता है।",
          ...
          telugu: {
            ...
            parking: "మేము పార్కింగ్ జోన్ B (తూర్పు) ను సిఫార్సు చేస్తున్నాము.\n- **కారణం**: జోన్ A 86% మరియు జోన్ C 98% నిండి ఉంది, ప్రవేశం ఆలస్యం అవుతోంది.\n- **విశ్వాసం**: 92%\n- **సిఫార్సు చేసిన చర్య**: జోన్ B కి వెళ్ళండి, ఇది 50% ఖాళీగా ఉంది.\n- **అంచనా వేసిన ప్రభావం**: వాహన రద్దీని నివారిస్తుంది.",
            food: "అత్యంత వేగవంతమైన ఎంపిక అరీనా ఎక్స్‌ప్రెస్ కేఫ్ (తూర్పు) (4 నిమిషాల నిరీక్షణ).\n- **కారణం**: గ్రాండ్ ఫుడ్ బజార్ (పడమర) లో ఆర్డర్లు ఎక్కువగా ఉన్నాయి (18 నిమిషాల నిరీక్షణ).\n- **విశ్వాసం**: 88%\n- **సిఫార్సు చేసిన చర్య**: తూర్పు కాన్‌కోర్స్‌కి వెళ్ళండి.\n- **అంచనా వేసిన ప్రభావం**: క్యూ సమయాన్ని 14 నిమిషాలు ఆదా చేస్తుంది.",
            washroom: "సమీపంలోని వాష్‌రూమ్: వాష్‌రూమ్ నార్త్ (టైర్ 1).\n- **కారణం**: వాష్‌రూమ్ ఈస్ట్ (టైర్ 2) శుభ్రత కోసం మూసివేయబడింది.\n- **విశ్వాసం**: 94%\n- **సిఫార్సు చేసిన చర్య**: నార్త్ కాన్‌కోర్స్ వాష్‌రూమ్‌ని ఉపయోగించండి (2 నిమిషాల నిరీక్షణ).\n- **అంచనా వేసిన ప్రభావం**: వేగంగా వాష్‌రూమ్ సదుపాయాన్ని అందిస్తుంది.",
